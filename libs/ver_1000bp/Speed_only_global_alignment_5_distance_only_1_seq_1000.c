...
//		printf("%c %c %f\n",A,B,imut[k][t]);
    ...
    int CC[1000] = {0,};
    int DD[1000] = {0,};
    unsigned long (*TT)[1000] = (unsigned long(*)[1000])malloc(sizeof(unsigned long)*1000*1000);
//    int TT[1500][2000] = {{0,},};
    int lenx,leny,i,j,x,y,flag;
    char temp;
    char aligned_seq1[2000] = "";
    char aligned_seq2[2000] = "";
//    char aligned_sum[8000] = "";
    char* aligned_sum = malloc(3300);
